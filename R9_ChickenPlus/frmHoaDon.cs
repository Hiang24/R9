...
namespace ChickenPlus
{
    public partial class frmHoaDon : Form
    {
        ...
        private void sodiem1_TextChanged(object sender, EventArgs e)
        {

        }

        private void manv1_TextChanged(object sender, EventArgs e)
        {

        }

        private void tienkhachdua_Click(object sender, EventArgs e)
        {

        }

        private void tienkhachdua1_TextChanged(object sender, EventArgs e)
        {

        }

        private void sodiem_Click(object sender, EventArgs e)
        {

        }

        private void tongtien1_TextChanged(object sender, EventArgs e)
        {
